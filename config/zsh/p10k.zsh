# Generated by Powerlevel10k configuration wizard on 2026-06-23 at 04:44 JST.
...
# vertical separators, round heads, flat tails, 2 lines, disconnected, right frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_FOREGROUND=166 # Red orange
  # Context color in SSH without privileges.
  typeset -g POWERLEVEL9K_CONTEXT_REMOTE_FOREGROUND=177 # Purple
  typeset -g POWERLEVEL9K_CONTEXT_REMOTE_SUDO_FOREGROUND=164 # Red Purple
  # Default context color (no privileges, no SSH).
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=182 # Light Purple
  ...
  # Note(cebrusfs): default on to show username
